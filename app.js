...
const FORTUNE_READINGS = Array.isArray(PROGRESSION_DATA.fortuneReadings) ? PROGRESSION_DATA.fortuneReadings : [];

const FORTUNE_RESOURCE_REWARDS = Array.isArray(PROGRESSION_DATA.fortuneResourceRewards) ? PROGRESSION_DATA.fortuneResourceRewards : [];

const CRAFTING_DATA = window.LIYUAN_CRAFTING_DATA || {};
const CHIP_CRAFT_RECIPES = Array.isArray(CRAFTING_DATA.chipRecipes) ? CRAFTING_DATA.chipRecipes : [];

const GEAR_CRAFT_RECIPES = Array.isArray(CRAFTING_DATA.gearRecipes) ? CRAFTING_DATA.gearRecipes : [];
...
const EVENT_DIALOGUE_DATA = window.LIYUAN_EVENT_DIALOGUE || {};
const EVENT_SPEAKERS = EVENT_DIALOGUE_DATA.speakers || {};
const INTRO_POST_CREATOR_CLASS_LINES = EVENT_DIALOGUE_DATA.postCreatorClassLines || {};
const EVENT_DIALOGUE_SEQUENCES = EVENT_DIALOGUE_DATA.sequences || {};
